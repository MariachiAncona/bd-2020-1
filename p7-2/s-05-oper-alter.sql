...
alter table pizzeria_almacen modify (requiere_surtir number(1,0) not null);
...
alter table empleado modify (ap_materno varchar2(40));
...
alter table status pedido add constraint status_pedido_pk primary key (status_pedido_id);
...
alter table empleado add column (pizzeria_id number (10,0) not null);
...
alter table empleado modify (fecha_ing date not null);
alter table pedido modify (importe_total number(10,2) not null);

prompt Cambio en fecha_apertura
alter table sucursal modify (fecha_apertura date default sysdate not null);

prompt Cambios en clave pizzeria
alter table pizzeria modify (clave varchar2(10) not null);
...
alter table pedido add column (pedido_id number(10,0));
alter table pedido add constraint pedido_pk primary key (pedido_id);
alter table pedido add constraint pedido_num_pedido_pizzeria_uk unique (num_pedido, pizzeria_id);
...
alter table pizzeria add constraint telefono_chk check(lenght(telefono)<=10);
