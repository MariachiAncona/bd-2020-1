...
grant p0701_admin_rol, create procedure, create sequence to jos_p0701_admin;
...
grant p0701_basic_rol,create procedure, create sequence to jos_p0701_oper;
...
grant p0701_guest_rol, create procedure, create sequence to jos_p0701_invitado;
