...
update cuenta set 
    fecha_estatus=to_date('25/12/2018 11:59:59','dd/mm/yyyy hh24:mi:ss'),
    estatus_cuenta_id=
...
prompt Eliminar portafolio inversión (obligatorio por propagación de llave)
delete from portafolio_inversion 
    where cuenta_id=
        (select cuenta_id from cuenta 
        where cliente_id=
...
prompt Eliminar cuenta de inversión (obligatorio por propagación de llave)
